        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    ...
                    <?php endif; ?>
                    <form method="POST" enctype="multipart/form-data" class="needs-validation card" novalidate>
                        <div class="row gy-4">
                            <!-- Name -->
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control styled-input" id="present_address" name="present_address"
                                    rows="3" required></textarea>
                            </div>
                            <!-- LinkedIn -->
                            <div class="col-12">
                                <label for="linkedin_profile" class="form-label">LinkedIn Profile (Optional)</label>
                                <input type="url" class="form-control styled-input" id="linkedin_profile"
                                    name="linkedin_profile">
                            </div>
                            <!-- Message -->
                            <div class="col-12">
                                <label for="message" class="form-label">Comments (If Any)</label>
                                <textarea class="form-control styled-input" id="message" name="message"
                                    rows="3"></textarea>
                            </div>
                            <!-- File -->
                            <div class="col-12">
                                <label for="attachment" class="form-label">Attach Your CV *</label>
                                <input type="file" class="form-control styled-input" id="attachment" name="attachment"
                                    required>
                            </div>
                            <!-- Submit -->
...
<!-- CSS -->
<style>
.apply-section .form-control.styled-input,
.apply-section .form-select.styled-input {
...
.apply-section .form-control.styled-input:focus,
.apply-section .form-select.styled-input:focus {
    border-color: #27ae60;
    outline: none;
}
