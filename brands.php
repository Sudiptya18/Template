        ...
        <div id="brands-container" class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
          <?php if (mysqli_num_rows($brands_result) > 0): ?>
            <?php while ($brand = mysqli_fetch_assoc($brands_result)): ?>
              <div class="col-lg-4 col-md-6 portfolio-item isotope-item" data-categories="<?= $brand['categories_ids'] ?>">
                <div class="brand-card" onclick="window.location.href='brand-details.php?brand_id=<?= $brand['brand_id'] ?>'">
