                        ...
                        <div class="col-md-6">
                            <div class="product-images">
                                ...
                                <div class="thumbnail-images"
                                    ...
                                    <img class="thumbnail"
                                        src="admin/uploads/products/<?php echo $product['p_image2']; ?>"
                        ...
                        <div class="row">
                            ...
                            <ul
                                ...
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="assets/img/icons/brand-icon.png" alt="" class="lazy-img m-auto icon">
                                    <span>Brand</span>
                                    <div><?php echo htmlspecialchars($product['brand_name']); ?></div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="assets/img/icons/category-icon.png" alt="" class="lazy-img m-auto icon">
                                    <span>Categories</span>
                                    <div><?php echo htmlspecialchars($product['category_name']); ?></div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="assets/img/icons/format-icon.png" alt="" class="lazy-img m-auto icon">
                                    <span>Format</span>
                                    <div><?php echo htmlspecialchars($product['format_name']); ?></div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="assets/img/icons/origin-icon.png" alt="" class="lazy-img m-auto icon">
                                    <span>Country of Origin</span>
                                    <div><?php echo htmlspecialchars($product['origin_name']); ?></div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="assets/img/icons/pack-icon.png" alt="" class="lazy-img m-auto icon">
                                    <span>Pack Size</span>
